 ...
 * Use the [FragmentoListado.newInstance] factory method to
...
class FragmentoListado : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_fragmento_listado, container, false)
    }
